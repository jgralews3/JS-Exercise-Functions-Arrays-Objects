...
*/
function getCarInfoByIndex(inventory1, index) {
return `This is a ${inventory1[index].car_make} ${inventory1[index].car_model}`
}
var inventory = [
  { id: 1, car_make: "Lincoln", car_model: "Navigator", car_year: 2009 },
  { id: 2, car_make: "Mazda", car_model: "Miata MX-5", car_year: 2001 },
...
*/
function getLastCarInfo(inventory3) {
  return `This is a ${inventory3[inventory3.length - 1].car_make} ${inventory3[inventory3.length - 1].car_model}`;
}
getLastCarInfo(inventory3);
...
*/
function getModelYears(yearinventory) {
  let yeararray=[];
  for (let i=0; i < yearinventory.length; i++){
    yeararray.push(yearinventory[i].car_year)
  }
  return yeararray;
}
 ...
 * it will return `This is a Lincoln Navigator`.
*/
function getCarInfoById(idinventory, idnumber) {
  return `This is a ${idinventory[idnumber-1].car_make} ${idinventory[idnumber-1].car_model}`
}
